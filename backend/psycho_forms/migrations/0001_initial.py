    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_created', models.DateTimeField(auto_now_add=True, verbose_name='Дата и время создания')),
                ('is_active', models.BooleanField(default=True, verbose_name='Является активным')),
                ('organisation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='psycho_forms.organization', verbose_name='Организация(владелец теста)')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='psycho_forms.question', verbose_name='Вопрос'),
        ),
    ]
